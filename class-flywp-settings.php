...
class FlyWP_Settings {
    ...
    public function render_dashboard() {
        // We will load a template file for the dashboard to keep things clean
        include FLYWP_WAAS_PLUGIN_DIR . 'templates/dashboard.php';
    }
    ...
    public function handle_create_site() {
        ...
        $response = $api->create_site( array(
            ...
            // Add other required fields according to FlyWP API docs
        ) );
